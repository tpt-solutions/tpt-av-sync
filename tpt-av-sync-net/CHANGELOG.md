...
### Verified
- 19 unit tests; integration tests over real sockets: TCP two-peer exchange, snapshot bootstrap, offline-reconnect flush, three-peer mesh convergence, WebSocket exchange, multicast discovery; engine event pass-through suite.
